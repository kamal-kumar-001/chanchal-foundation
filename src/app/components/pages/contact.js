      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4">
          <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
            <p className="text-base font-semibold uppercase tracking-wide text-[#ff5722]">
              Contact
            </p>
            <h2 className="font-heading mb-4 font-bold tracking-tight text-gray-900 text-3xl sm:text-5xl">
              Get in Touch
          ...
          <div className="grid md:grid-cols-2">
            <div className="h-full pr-6">
              ...
              <ul className="mb-6 md:mb-0">
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-[#ff5722] text-gray-50">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600">225/3 Uttam Nagar , Rewari</p>
                ...
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600">Mobile: +91 9466394803</p>
                    <p className="text-gray-600">Mail: vijayveersunariya@yahoo.in</p>
                  </div>
                </li>
              </ul>
            </div>
